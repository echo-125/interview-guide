import { j as t, k as I, R as S, Z as D } from "./ui-vendor-D79l2AJO.js";
import { e as P, b as C, r as s } from "./react-vendor-ek4qDQiW.js";
import { v as u } from "./voiceInterview-DaxB5Ok2.js";
import L from "./InterviewDetailPanel-ZEaa4FTU.js";
...
function Z() {
  const { sessionId: a } = P(), d = C(), [r, p] = s.useState(null), [E, n] = s.useState(true), [g, m] = s.useState(null), [b, x] = s.useState(null), [w, v] = s.useState(() => Date.now()), [j, l] = s.useState(null), o = s.useRef(null);
  s.useEffect(() => (A(), () => {
  ...
  const A = async () => {
    ...
    m(i), v(Date.now()), x((h) => e.evaluateStatusUpdatedAt ?? h ?? (/* @__PURE__ */ new Date()).toISOString()), i === "COMPLETED" && e.evaluation ? (p(e.evaluation), n(false)) : i === "FAILED" ? (l("\u8BC4\u4F30\u4EFB\u52A1\u672A\u80FD\u5B8C\u6210\uFF0C\u8BF7\u91CD\u65B0\u751F\u6210"), n(false)) : N();
  }, N = s.useCallback(() => {
